...
def catch_all(path):
    ...
    # Serve from the static folder ('dist/') if static_folder path is set and it's a file
    full_path = os.path.join(app.static_folder, path) if app.static_folder else ""
    if app.static_folder and path != "" and os.path.exists(full_path) and os.path.isfile(full_path):
        return send_from_directory(app.static_folder, path)
    else:
        # Default fallback to client index.html
