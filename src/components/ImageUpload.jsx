      ...
      <AnimatePresence mode="wait">
        {!preview ? (
          ...
          >
            ...
            {/* Preview Image */}
            <div className="max-h-[350px] w-full flex items-center justify-center overflow-hidden rounded-2xl bg-white dark:bg-slate-950 border border-slate-200/40 dark:border-slate-800/40">
              <img
                src={preview}
      ...
      {zoomOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
          <div className="relative max-w-4xl w-full bg-white dark:bg-slate-900 rounded-3xl p-3 border border-slate-200 dark:border-slate-800 overflow-hidden shadow-2xl flex flex-col">
            ...
            <div className="max-h-[80vh] overflow-auto flex justify-center bg-slate-50 dark:bg-slate-950 rounded-2xl">
              <img
                src={preview}
