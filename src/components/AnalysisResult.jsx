...
const AnalysisResult = ({ result, imageFile, onRegenerate, onReset }) => {
  ...
  useEffect(() => {
    if (result && result.valid) {
      ...
      // Standard Gemini output contains bulleted descriptions. Let's parse them or split logically:
      // Observations, Possible Findings, Recommendations
      const tempSections = {
        observations: '',
        findings: '',
        recommendations: '',
      ...
      // Simple keyword matching helper to group paragraphs
      ...
      // Fallback if split was too sparse: split roughly into 3 parts
  ...
  const handleShare = () => {
    // Copy a mock report share link to clipboard
  ...
  // Simplifies medical terminology by replacing medical jargon with simple definitions
  const getSimplifiedText = (text) => {
    let simplified = text;
    Object.entries(MEDICAL_JARGON_MAP).forEach(([jargon, simple]) => {
      // Use regex to replace case-insensitively while highlighting the simplification
  ...
  return (
    <div className="space-y-8 w-full max-w-4xl mx-auto">
      ...
      {/* Grid: Image and Results Description */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        {/* Right Column: Observation Panels */}
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
            ...
            {/* Audio & Jargon simplification Toggles */}
            <div className="flex items-center gap-2">
              {/* Simplify jargon toggle */}
              <button
          ...
          {/* Disclaimer (Premium alert style) */}
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pt-6 border-t border-slate-200 dark:border-slate-800">
            ...
            {/* Right side actions: Reset/Reset uploader */}
            <div className="flex items-center gap-2">
              <button
