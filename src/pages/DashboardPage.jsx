...
const DashboardPage = () => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      let result;
      // If selectedFile is a string URL (from public samples), we fetch it and construct a File object
      ...
      // Delay slightly for visual comfort (so they see the 'Completed' step check)
      setTimeout(async () => {
        setIsLoading(false);
        cancelLoaderAnimation();
        
        if (result.valid) {
          // Save report to localStorage + IndexedDB
          ...
          // Rejected by medical validation screen
              ...
              >
                ...
                {error && (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-rose-800 dark:text-rose-450">Analysis Failed</h4>
